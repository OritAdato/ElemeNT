...
specie_ElemeNTannotNorm_dir = os.path.join(dir_mainPath,"csRNAseq//ElemeNTout//normlized")
...
for motifName in motifName_l:
    ...
    meanScore_out_fn = os.path.join(targetGraphInput_dir,specie_name + '_nascentRNAallDS_' + motifName + '_meanScore.txt')
    percent_out_fn = os.path.join(targetGraphInput_dir, specie_name + '_nascentRNAallDS_' + motifName + '_percent.txt')
